...
defineProps(['sumPrice', 'tax'])
const emit = defineEmits(['closeDrawer', 'remove-from-drawer'])
...
<template>
    ...
    <div class="fixed top-0 right-0 z-20 h-full w-96 bg-white p-7 overflow-y-auto">
        <div class="flex flex-row gap-4">
            <button @click="closeDrawer" class="bg-lime-500 hover:bg-lime-600 active:bg-lime-700 rounded-large p-2 rotate-180 mb-10">
